		...
		*/
	  	public static void setWatemark(String imagePath){ 
			...
			*/
	  		...
	  		if("yes".equals(MyStartFilter.sp.get("isCheck1"))){
				pressText(MyStartFilter.sp.get("fcontent").toString(), imagePath, "", 1, Color.RED, 
						Integer.parseInt(MyStartFilter.sp.get("fontSize")), Integer.parseInt(MyStartFilter.sp.get("fontX")), 
						Integer.parseInt(MyStartFilter.sp.get("fontY")));	//文字
			}
	  		//图片水印
	  		/*
			...
			*/
	  		if("yes".equals(MyStartFilter.sp.get("isCheck2"))){
				pressImage(PathUtil.getClasspath() + Const.FILEPATHIMG + MyStartFilter.sp.get("imgUrl"), imagePath, 
						Integer.parseInt(MyStartFilter.sp.get("imgX")), Integer.parseInt(MyStartFilter.sp.get("imgY")));
			}
		  } 
