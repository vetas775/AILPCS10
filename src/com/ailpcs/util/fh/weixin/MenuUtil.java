package com.ailpcs.util.fh.weixin;
...
import com.ailpcs.entity.WxButton;
import com.ailpcs.entity.WxCommonButton;
import com.ailpcs.entity.WxComplexButton;
import com.ailpcs.entity.WxMenu;
import com.ailpcs.entity.WxViewButton;
...
public class MenuUtil {
	 ...
	 * 	创建自定义菜单(每天限制1000次)
	 * */
	public static int createMenu(WxMenu menu,String appid, String appsecret){
	 ...
	 * @return
	 */
	public static WxMenu getMenu(List<PageData> varList){
		...
		WxComplexButton cx2 = new WxComplexButton();
		if(null != M2.getString("TITLE") && !"".equals(M2.getString("TITLE").trim())){
			WxButton[] arrayB = new WxButton[listm2.size()];
		...
		WxComplexButton cx3 = new WxComplexButton();
		if(null != M3.getString("TITLE") && !"".equals(M3.getString("TITLE").trim())){
			WxButton[] arrayB = new WxButton[listm3.size()];
		...
		menu.setButton(new WxComplexButton[]{cx1,cx2,cx3});
		return menu;
	}
}