package com.ailpcs.controller.wechat;
...
import com.ailpcs.service.other.impl.CommandService;
import com.ailpcs.service.other.impl.ImgmsgService;
import com.ailpcs.service.other.impl.TextmsgService;
		...
		try{
			...
			if(null != signature && null != timestamp && null != nonce && null != echostr){/* 接口验证  */
			    ...
			    List<String> list = new ArrayList<String>(3) { 
		           ...
		           list.add(MyStartFilter.sp.get("Token"));
				   list.add(timestamp); 
				   list.add(nonce); 
