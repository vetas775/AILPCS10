...
import com.ailpcs.service.other.LogInImgManager;
import com.ailpcs.util.fh.DelAllFile;
import com.ailpcs.util.fh.PathUtil;

/** 
 * 说明：系统设置-配置4: 登录页面背景图片增删改查接口
 * MichaelTsui Amend 17/06/21
 */
@Controller
@RequestMapping(value="/loginimg")
public class SysSetting04LoginImageController extends BaseController {
	...
	/**系统设置-配置4: 背景图片列表
	 * 接口调用者: WEB-INF\jsp\system\head\sys_edit.jsp -> \static\js\myjs\sys.js[loginImg()]
	 * @throws Exception
	 */
