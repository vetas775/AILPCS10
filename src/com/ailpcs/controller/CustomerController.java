...
public class CustomerController extends BaseController {
	private static final String menuUrl = "happuser/listUsers.do"; //菜单地址(权限用)
	...
	public ModelAndView listUsers(Page page){
		...
		try{
			...
			pd.put("roleId", "2");
			List<RoleDO> roleList = (List<RoleDO>) daoRole.listFromDb("RoleMapper.listSubRolesByParentId", pd);	//列出会员组角色
