...
import com.ailpcs.service.other.TimingBackUpManager;
...
import com.ailpcs.util.fh.QuartzManager;
...
public class TimingBackUpController extends BaseController {
	private static final String menuUrl = "timingbackup/list.do"; //菜单地址(权限用)
