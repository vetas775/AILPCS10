...
import com.ailpcs.service.impl.SysDbBackupRecoveryServiceImpl;
import com.ailpcs.service.other.impl.TimingBackUpService;
...
public class DbBackupQuartzJob extends BaseController implements Job{
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		SysDbBackupRecoveryServiceImpl brdbService = (SysDbBackupRecoveryServiceImpl)webctx.getBean("brdbService");
		PageData pd = new PageData();
		try {
			String kackupPath = DbUtil.getDbFH().backup(TABLENAME).toString();//调用数据库备份
