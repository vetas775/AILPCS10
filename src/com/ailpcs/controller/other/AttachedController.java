...
import com.ailpcs.service.other.AttachedManager;
import com.ailpcs.service.other.AttachedMxManager;
...
public class AttachedController extends BaseController {
	private static final String menuUrl = "attached/list.do"; //菜单地址(权限用)
