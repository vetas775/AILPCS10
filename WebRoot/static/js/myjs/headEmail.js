...
function sendEm(){
	...
	$.ajax({
		type: "POST",
		url: locat+'/headPanel/sendEmail.do?tm='+new Date().getTime(),
...
function editEmail(){
   var EMAIL = $("#EMAIL").val();
   var result = showModalDialog(locat+"/headPanel/editEmail.do?EMAIL="+EMAIL,"","dialogWidth=600px;dialogHeight=380px;");
