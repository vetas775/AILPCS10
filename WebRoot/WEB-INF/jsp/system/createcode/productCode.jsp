...
<head>
	<base href="<%=basePath%>">
	<%@ include file="../index/top.jsp"%> <!-- jsp文件头和头部 -->
	<style type="text/css">
...
<body class="no-skin">
    <div class="main-container" id="main-container"> <!-- /section:basics/navbar.layout -->
	<div class="main-content"> <!-- /section:basics/sidebar -->
		<!-- 添加属性  -->
					       	...
					       	<tr height="42px;">
					       		...
					       		<td>
									...
									<div class="nav-search" style="float: right;padding-right: 5px;">
										...
										<input type="hidden" name="jdbcType" id="jdbcType"/>  
										<input type="hidden" name="uCamel" id="uCamel"/>  <!-- Michael新增 : var[7]把驼峰规则的属性名首字母变大写 -->
									</div>
								</td>
					       	</tr>
					       	<tr height="42px;">
		...
		<form action="createCode/proCode.do" name="Form" id="Form" method="post">
			...
			<input type="hidden" name="jdbcTypePk" id="jdbcTypePk" value="${pd.jdbcTypePk}"> <!--Michael17/07/08 记录主键的JDBC数据类型  -->
			<input type="hidden" name="parameterTypePK" id="parameterTypePK" value="${pd.parameterTypePK}"> <!--Michael17/07/08 记录主键的Parameter Type数据类型  -->
			<input type="hidden" name="pkGetter" id="pkGetter" value="${pd.pkGetter}">  <!-- //Michael17/07/08 记录主键的getter事件名 -->
			<div id="zhongxin">
			<table style="margin-top: 10px;">
						...
						<table style="margin-top: 5px;">
							<tr>
								<td style="width:76px;text-align: right;">二级包名：</td>
								...
								<td>&nbsp;&nbsp;例如:com.<font color="red" style="font-weight: bold;">ailpcs</font>.controller&nbsp;&nbsp;红色部分即为二级包名</td>
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td style="width:76px;text-align: right;">表主键：</td>
								<td><input type="text" name="tabletop" id="tabletop" value="${msg == 'add' ? 'TB_' : ''}${fn:split(pd.TABLENAME, ',fh,')[0]}" placeholder="这里输入表主键字段名, 如: doc_id" style="width:156px" title="表主键"/></td>
							</tr>
						</table>
	...
	<%@ include file="../index/foot.jsp"%> <!-- 页面底部js¨ -->
	...
	<script type="text/javascript">
		...
		function reductionFields(){
			...
			if('edit' == msg){
				...
				var fieldarray = nowarField.split('Q416852186');
