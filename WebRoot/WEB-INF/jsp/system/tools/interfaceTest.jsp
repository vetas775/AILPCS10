								...
								<div class="widget-body">
								 <div class="widget-main">
										<div class="step-content row-fluid position-relative">
											...
											<label>Token</label>
											<input name="S_TYPE_S" id="S_TYPE_S" style="width:200px;" type="text" value="userToken" title="例子">
										</div>
										<div class="step-content row-fluid position-relative" style="padding-top: 10px;">
											<div style="float: left;">
												<span class="input-icon">
													<input type="text" id="serverUrl" title="输入请求地址" value="<%=basePath%>appuser/getAppuserByUerId.do?userId=1" style="width:640px;">
										...
										<div class="step-content row-fluid position-relative" style="padding-top: 10px;">
										<textarea id="json-field" title="返回结果" class="autosize-transition span12" style="width:760px;"></textarea>
									 	</div>
									 	<div class="step-content row-fluid position-relative">
										...
										<div class="step-content row-fluid position-relative">
											<ul class="unstyled spaced2">
												<li class="text-warning orange"><i class="ace-icon fa fa-exclamation-triangle"></i>
													相关参数协议：result: 00	请求失败 ; 01	请求成功; 02	返回空值; 03	请求协议参数不完整  ; 04  用户名或密码错误; 05  Token验证失败
												</li>
