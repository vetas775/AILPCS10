							...
							<div class="tabbable">
						            ...
						            <div class="tab-content">
									  <div id="home" class="tab-pane in active">
										<form action="headPanel/saveSysMenu1.do" name="Form" id="Form" method="post">
									  ...
									  <div id="profile" class="tab-pane">
									  	<form action="headPanel/saveSysMenu2.do" name="Form2" id="Form2" method="post">
										<table id="table_report" class="table table-striped table-bordered table-hover">
											<tr>
												<td style="text-align: center;" colspan="100">
													文字水印配置
									  ...
									  <div id="profile3" class="tab-pane">
									  	<form action="headPanel/saveSysMenu3.do" name="Form3" id="Form3" method="post">
									  ...
									  <div id="profile4" class="tab-pane">
									  	<form action="headPanel/saveSysMenu4.do" name="Form4" id="Form4" method="post">
										...
										<table id="table_report" class="table table-striped table-bordered table-hover">
											...
											<tr>
												...
												<td>
													<label style="float:left;padding-left: 5px;padding-top:7px;">
														<input name="login-field-1" onclick="openZc();" class="ace ace-switch ace-switch-3" type="checkbox" <c:if test="${pd.regFlag == 'yes' }">checked="checked"</c:if> >
														<span class="lbl"></span>
													</label>
												</td>
										...
										<input type="hidden" name="isZhuce" id="isZhuce" value="${pd.regFlag }"/>
