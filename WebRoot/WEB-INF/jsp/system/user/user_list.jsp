					...
					<div class="row">
						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td><font color="#808080">最近登录时间： </font></td>
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<a class="btn btn-xs btn-info" title='发送站内信' onclick="goSendInnerMsg('${user.USERNAME }');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${QX.BTN0001 == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="goSendInnerMsg('${user.USERNAME }');" class="tooltip-info" data-rel="tooltip" title="发送站内信">
																	<span class="blue">
...
function sendSms(phone){
	 ...
	 diag.Drag=true;
	 diag.Title ="发送短信";
	 diag.URL = '<%=basePath%>headPanel/goSendSms.do?PHONE='+phone+'&msg=appuser';
	 diag.Width = 600;
	 diag.Height = 265;
	 diag.CancelEvent = function(){ //关闭事件
		diag.close();
...
function sendEmail(EMAIL){
	 ...
	 diag.Drag=true;
	 diag.Title ="发送电子邮件";
	 diag.URL = '<%=basePath%>headPanel/goSendEmail.do?EMAIL='+EMAIL;
	 diag.Width = 660;
	 diag.Height = 486;
	 diag.CancelEvent = function(){ //关闭事件
		diag.close();
