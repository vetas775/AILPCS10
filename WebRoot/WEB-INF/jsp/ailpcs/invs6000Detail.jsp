		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="invs6000/${msg}.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">赞:</td>
								<td><input type="number" name="readerLike" id="readerLike" value="${pd.readerLike}" maxlength="32" placeholder="这里输入赞" title="赞" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">踩:</td>
								<td><input type="number" name="readerDeny" id="readerDeny" value="${pd.readerDeny}" maxlength="32" placeholder="这里输入踩" title="踩" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">建档人:</td>
								<td><input type="text" name="insertUser" id="insertUser" value="${pd.insertUser}" maxlength="30" placeholder="这里输入建档人" title="建档人" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">建档日期:</td>
								<td><input class="span10 date-picker" name="insertDate" id="insertDate" value=<fmt:formatDate value="${pd.insertDate}" pattern="yyyy-MM-dd HH:mm:ss"/> type="text" data-date-format="yyyy-mm-dd HH:mm:ss" readonly="readonly" placeholder="建档日期" title="建档日期" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">修改人:</td>
								<td><input type="text" name="updateUser" id="updateUser" value="${pd.updateUser}" maxlength="30" placeholder="这里输入修改人" title="修改人" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">修改日期:</td>
								<td><input class="span10 date-picker" name="updateDate" id="updateDate" value=<fmt:formatDate value="${pd.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/> type="text" data-date-format="yyyy-mm-dd HH:mm:ss" readonly="readonly" placeholder="修改日期" title="修改日期" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="text-align: center;" colspan="10">
									<a class="btn btn-mini btn-primary" onclick="saveInvs6000();">保存</a>
